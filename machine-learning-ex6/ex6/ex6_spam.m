...
filename1 = 'emailSample1.txt';
filename2 = 'emailSample2.txt';
filename3 = 'spamSample1.txt';
filename4 = 'spamSample2.txt';
% Read and predict
file_contents1 = readFile(filename1);
file_contents2 = readFile(filename2);
file_contents3 = readFile(filename3);
file_contents4 = readFile(filename4);
...
word_indices4  = processEmail(file_contents4);
x4             = emailFeatures(word_indices4);
p4 = svmPredict(model, 4);
